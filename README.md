...
Open the Terminal/Command-prompt. Change to a directory of your choice and run `flutter create calculator_app`. Open the calculatorApp in VS Code or Android Studio.

## Add codes for the calculator app
Go to the `lib` folder and open the `main.dart` file. Inside the `main.dart` file copy and paste the following codes:
...
Still inside the `lib` folder, create a file and name it `my_button.dart`. Inside the `my_button.dart` file, copy and paste the following codes:
